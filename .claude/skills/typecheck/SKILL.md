---
name: typecheck
description: Run TypeScript type-checking, ESLint and the Vitest suite on the mmv-warehouse React app. Use before considering a change to the React app (mmv-warehouse/mmv-warehouse/) done, since there is no CI — this is the whole automated safety net.
---
